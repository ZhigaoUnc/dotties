...
Item {
    ...
    readonly property color bgTop: Qt.rgba(0 / 255, 0 / 255, 0 / 255, 0.97)
    readonly property color bgBot: Qt.rgba(0 / 255, 0 / 255, 0 / 255, 0.97)
    readonly property color hair: Qt.rgba(255 / 255, 255 / 255, 255 / 255, 0.10)
    readonly property color verm: "#333333"
    readonly property color cream: "#ffffff"
    readonly property color dim: "#777777"
