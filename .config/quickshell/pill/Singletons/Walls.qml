...
Singleton {
    ...
    readonly property string thumbDir: (Quickshell.env("XDG_CACHE_HOME") || (Quickshell.env("HOME") + "/.cache")) + "/dingaling-wp-thumbs/"
    readonly property string thumbScript: Quickshell.env("HOME") + "/.config/scripts/dingaling/wallpaper-thumbs.sh"
    readonly property string setScript: Quickshell.env("HOME") + "/.config/scripts/dingaling/wallpaper.sh"
    readonly property string stateFile: (Quickshell.env("XDG_STATE_HOME") || (Quickshell.env("HOME") + "/.local/state")) + "/dingaling-wallpaper"
