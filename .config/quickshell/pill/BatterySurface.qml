    ...
    Column {
        ...
        Item {
            ...
            Row {
                ...
                Repeater {
                    model: [
                        { value: PowerProfile.PowerSaver, glyph: "leaf" },
                        { value: PowerProfile.Balanced, glyph: "sun" },
                        { value: PowerProfile.Performance, glyph: "bolt" }
                    ]

                    delegate: Item {
                        required property var modelData
                        readonly property bool active: typeof PowerProfiles !== "undefined" && PowerProfiles.profile === modelData.value
                        readonly property bool available: typeof PowerProfiles === "undefined" || modelData.value !== PowerProfile.Performance || PowerProfiles.hasPerformanceProfile
                        ...
                        Rectangle {
                            anchors.fill: parent
                            radius: 6 * root.s
                            color: active ? Qt.alpha(Theme.verm, 0.15) : "transparent"
                            border.width: 1
                            border.color: active ? Theme.verm : Theme.border
                        ...
                        GlyphIcon {
                            ...
                            color: active ? Theme.verm : Theme.dim
                            stroke: 1.6
                            Behavior on color { ColorAnimation { duration: 150 } }
                        }
